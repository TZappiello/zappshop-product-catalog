...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        problemDetail.setType(URI.create("/erros/invalid-fields"));
    ...
    @ExceptionHandler(ResoucerNotFoundExcetion.class)
    public ProblemDetail handleResoucerNotFoundExcetion(ResoucerNotFoundExcetion e) {
